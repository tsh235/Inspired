...
export const renderFooter = () => {
      ...
      <ul class="footer-social__list">
        <li class="footer-social__item">
          <a href="" class="footer-social__link footer-social__link--vk">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="Вконтакте">
  ...
  createElement('div', {
    ...
    innerHTML: `
      <a class="footer-contacts__link footer__link" href="mailto:Inspired@gmail.com">Inspired@gmail.com</a>
      <a class="footer-contacts__link footer__link" href="tel:89304902620">8 930 490 26 20</a>
    `,
  }, {parent: footerContainer});

  createElement('div', {
    className: 'footer__item footer__item--copyright footer-copyright',
    innerHTML: `
      <p>© INSPIRED, 2023</p>
    `,
  }, {parent: footerContainer});
...
createElement('div', {
    className: 'footer__item footer__item--development footer-development',
    innerHTML: `
      <ul class="footer-development__list">
        <li class="footer-development__item">Designer: <a class="footer__link" href="https://t.me/Mrshmallowww">Anastasia Ilina</a></li>
        <li class="footer-development__item">Developer: <a class="footer__link" href="#!">Tatyana Shustrova</a></li>
      </ul>
    `,
  }, {parent: footerContainer});
